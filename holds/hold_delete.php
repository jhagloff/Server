...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-unit container">
	  ...
	  <p>Press Delete Hold to erase current Hold</p>
		<form method="post" action="hold_delete.php?hold_id=<?php echo"$res"; ?>">
		<input class="btn btn-danger" name="confirm" type="submit" value="Delete Hold">
		</form>
