...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-unit container">
	  ...
	  <p>Press Delete to erase the Resource on Loan</p>
		<form method="post" action="rol_delete.php?rol_id=<?php echo"$user"; ?>">
		<input class="btn btn-danger" name="confirm" type="submit" value="Delete">
		</form>
