...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-unit container">
	  ...
	  <p>Press Delete User to erase the User</p>
		<form method="post" action="delete_user.php?usr_id=<?php echo"$user"; ?>">
		<input class="btn btn-danger" name="confirm" type="submit" value="Delete User">
		</form>
