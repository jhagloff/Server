...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-unit container">
	  ...
	  <p>Press Delete Resource to erase the User</p>
		<form method="post" action="resource_delete.php?res_id=<?php echo"$res"; ?>">
		<input class="btn btn-danger" name="confirm" type="submit" value="Delete Resource">
		</form>
